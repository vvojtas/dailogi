...
create table dialogue (id bigint generated by default as identity, created_at TIMESTAMP WITH TIME ZONE not null, name varchar(255) not null, scene_description TEXT, is_global boolean not null default false, status varchar(20) not null, updated_at TIMESTAMP WITH TIME ZONE not null, user_id bigint not null, primary key (id));
