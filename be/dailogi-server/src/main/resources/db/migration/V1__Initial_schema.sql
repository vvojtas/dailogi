...
create table avatar (id bigint generated by default as identity, created_at TIMESTAMP WITH TIME ZONE not null, data blob not null, format_type varchar(20) not null, updated_at TIMESTAMP WITH TIME ZONE not null, primary key (id));
